...
import edu.training.droidbountyhunter.ActivityOpenGLFugitivos;
...
public class SimpleRederer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        float positivoSup = ActivityOpenGLFugitivos.distorcion;
        float negativoSup = ActivityOpenGLFugitivos.distorcion * (-1.0f);
        float positivoInf = ActivityOpenGLFugitivos.distorcion2;
        float negativoInf = ActivityOpenGLFugitivos.distorcion2 * (-1.0f);
