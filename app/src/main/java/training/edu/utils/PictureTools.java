...
public class PictureTools {
    ...
    private static int getCameraPhotoOrientation(String imagePath){
        ...
        try {
            ...
            /**
             * ExinfInterface permite obtener la metadata de las fotos para poder setear la orientación correcta.
             * Esto debido a que cada proveedor maneja la rotación de las fotos de manera distinta.
             */
